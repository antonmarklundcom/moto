...
slug: como-sacar-buenas-fotos-para-vender-tu-moto
excerpt: Luz, ángulos y detalles que tenés que mostrar, más cómo escribir una buena descripción y poner un precio honesto para que te escriban compradores en serio.
meta_description: Cómo vender tu moto más rápido: fotos con buena luz, los ángulos que busca el comprador, una descripción clara y un precio honesto. Guía práctica.
...
## Antes de sacar la primera foto
...
## Las fotos que busca el comprador
...
1. **De costado, la moto entera.** Es la mejor portada: se ve el tipo de moto, el estado general y las cubiertas. Sacala a la altura del motor, no desde arriba.
2. **Del otro costado.** El comprador quiere ver los dos lados, sobre todo si uno tiene raspones.
3. **De frente**, con el faro y el guardabarros.
4. **De atrás**, con la luz trasera y la chapa.
5. **El tablero**, con el kilometraje que se lea bien. Si podés, con la moto encendida para que se vean las luces del tablero.
6. **El motor**, de cerca y del lado donde se ven mejor el cilindro y la cadena.
7. **Las cubiertas**, para que se vea cuánto dibujo les queda.
8. **Los detalles**: asiento, escape, frenos, y cualquier accesorio que suma.

Sacá las fotos con el celular en horizontal y con la moto ocupando casi todo el cuadro.

## Mostrá lo que tiene, también lo malo
...
- **Fotos con tu número de teléfono escrito encima.** Los datos de contacto van en los campos del formulario, no en las fotos ni en la descripción.

## Una descripción que responda las preguntas

Una buena descripción te evita contestar lo mismo diez veces por WhatsApp. El formulario te pide un mínimo de texto; aprovechalo para contar:
...
- Si aceptás negociar o recibís otra moto como parte de pago, marcalo en el formulario: ahorra mensajes.
...
Si querés ver cómo se ven otras publicaciones, recorré las [motos publicadas](/motos) antes de sacar las tuyas. Con las fotos listas, ya podés publicar. No necesitás crear una cuenta. Revisamos cada publicación antes de que salga en el sitio.

[Publicá tu moto gratis](/publicar)
