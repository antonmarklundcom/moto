...
import { container, fieldClass, linkClass, primaryButton } from "@/components/public/styles";
...
export default async function Page(props: Props) {
  ...
  return (
    <div className={container}>
      ...
      />
      <h1 className="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Motos en cuotas en Paraguay</h1>
      ...
      <form method="get" action={paths.enCuotas} className="mt-4 grid max-w-2xl grid-cols-2 items-end gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:grid-cols-3">
